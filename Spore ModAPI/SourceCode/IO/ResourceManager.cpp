...
namespace Resource
{
	...
	auto_METHOD_VIRTUAL(cResourceManager, cResourceManager, bool, GetCachedResource, Args(const ResourceKey& name, ResourceObjectPtr* pDst), Args(name, pDst));
	...
	auto_METHOD_VIRTUAL_const(cResourceManager, cResourceManager, size_t, GetTypeRemap, Args(eastl::vector<uint32_t>& dst, uint32_t nTypeID), Args(dst, nTypeID));
	...
	auto_METHOD_VIRTUAL(cResourceManager, cResourceManager, size_t, func34h, Args(eastl::vector<ResourceKey>& pDst, int arg_4), Args(pDst, arg_4));
	auto_METHOD_VIRTUAL_const(cResourceManager, cResourceManager, size_t, GetFileKeys, Args(eastl::vector<ResourceKey>& dst, IResourceFilter* request, eastl::vector<DBPF*>* pDstDBPFs), Args(dst, request, pDstDBPFs));
	...
	auto_METHOD_VIRTUAL_const(cResourceManager, cResourceManager, size_t, GetResourceFactories, Args(eastl::list<IResourceFactory*>& dst, uint32_t nTypeID), Args(dst, nTypeID));
	auto_METHOD_VIRTUAL(cResourceManager, cResourceManager, bool, AddDBPF, Args(bool arg_0, Database* pDBPF, int nPriority), Args(arg_0, pDBPF, nPriority));
	...
	auto_METHOD_VIRTUAL_const(cResourceManager, cResourceManager, size_t, GetResourceCaches, Args(eastl::list<IResourceMap*>& dst), Args(dst));
	auto_METHOD_VIRTUAL(cResourceManager, cResourceManager, bool, AddFileName, Args(const char16_t* pFileName), Args(pFileName));
	auto_METHOD_VIRTUAL_VOID_const(cResourceManager, cResourceManager, GetFileName, Args(const ResourceKey& resourceKey, eastl::string16& dst), Args(resourceKey, dst));
