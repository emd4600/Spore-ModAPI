...
const RenderWare::VertexElement AnimEditorBlocks::Vertex::ELEMENTS[4] = {
		{0, offsetof(Vertex, pos), D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_POSITION, 0, RenderWare::RWDECL_VERTEX_POSITION},
		{0, offsetof(Vertex, normal), D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_NORMAL, 0, RenderWare::RWDECL_VERTEX_NORMAL},
		{0, offsetof(Vertex, uv), D3DDECLTYPE_FLOAT2, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_TEXCOORD, 0, RenderWare::RWDECL_VERTEX_TEXCOORD0},
		{0, offsetof(Vertex, color), D3DDECLTYPE_D3DCOLOR, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_COLOR, 0, RenderWare::RWDECL_VERTEX_COLOR}
};
