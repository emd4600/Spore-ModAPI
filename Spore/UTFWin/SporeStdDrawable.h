...
namespace UTFWin
{
	...
	namespace InternalAddressList(SporeStdDrawable)
	{
		DefineAddress(Paint, GetAddress(0x8320F0, 0x831870, 0x8318F0));
		DefineAddress(IsColliding, GetAddress(0x831EA0, 0x831620, 0x8316A0));
		DefineAddress(GetDimensions, GetAddress(0x831E10, 0x831590, 0x831610));
		DefineAddress(UseCollision, GetAddress(0x988640, 0x9882F0, 0x9882F0));
		DefineAddress(GetScale, GetAddress(0x8313F0, 0x830B70, 0x830BF0));

		DefineAddress(SetSerializer, GetAddress(0x831200, 0x830970, 0x8309F0));
		DefineAddress(GetProxyID, GetAddress(0x831360, 0x830AE0, 0x830B60));
	}
