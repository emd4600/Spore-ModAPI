...
namespace UTFWin
{
	...
	namespace InternalAddressList(ModulateEffect)
	{
		...
		DefineAddress(SetSerializer, GetAddress(0x9804D0, 0x9801D0, 0x980200));
		DefineAddress(GetProxyID, GetAddress(0x980410, 0x980110, 0x980140));

		DefineAddress(func84h, GetAddress(0x9803A0, 0x9800A0, 0x9800D0));

		DefineAddress(ToWinProc, GetAddress(0x980500, 0x980200, 0x980230));
		DefineAddress(GetColors, GetAddress(0x9803D0, 0x9800D0, 0x980100));
		DefineAddress(SetColors, GetAddress(0x9803F0, 0x9800F0, 0x980120));
	}
}