...
namespace Simulator
{
	...
	namespace InternalAddressList(cArtilleryWeaponStrategy)
	{
		DefineAddress(OnHit, GetAddress(0x105C870, NO_ADDRESS, 0x105BCD0));
		DefineAddress(WhileFiring, GetAddress(0x10588C0, NO_ADDRESS, 0x1057D20));
	}
}