...
namespace Simulator
{
	...
	public:
		...
		/// <li>If the method returns false, the tool is disabled and cannot be selected.
		/// <li>If the method returns true, the tool is enabled and can be used.
		///
		/// @param pTool The space tool.
		...
		/* 30h */	virtual bool OnHit(cSpaceToolData* pTool, const Vector3& position, cSpaceToolData::SpaceToolHit hitType);
