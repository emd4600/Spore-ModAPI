...
namespace Resource
{
	...
	namespace InternalAddressList(cResourceManager)
	{
		DefineAddress(NeedsToRelease, GetAddress(0x8DE6D0, 0x8DE520, 0x8DE530));
		DefineAddress(ReleaseResources, GetAddress(0x8E1CC0, 0x8E19C0, 0x8E19D0));
		DefineAddress(GetResource, GetAddress(0x8DF7E0, 0x8DF6F0, 0x8DF700));
		DefineAddress(func10h, GetAddress(0x8DF810, 0x8DF720, 0x8DF730));
		DefineAddress(GetCachedResource, GetAddress(0x8DE730, 0x8DE580, 0x8DE590));
		DefineAddress(func18h, GetAddress(0x8DFB50, 0x8DFA60, 0x8DFA70));
		DefineAddress(ReadResource, GetAddress(0x8DFCF0, 0x8DFC00, 0x8DFC10));
		DefineAddress(WriteResource, GetAddress(0x8DEE90, 0x8DED90, 0x8DEDA0));
		DefineAddress(SetTypeRemap, GetAddress(0x8E1EF0, 0x8E1BF0, 0x8E1C00));
		DefineAddress(GetTypeRemap, GetAddress(0x8E0E70, 0x8E0B80, 0x8E0B90));
		DefineAddress(GetGeneralTypeID, GetAddress(0x8DFD20, 0x8DFC30, 0x8DFC40));
		DefineAddress(GetRealFileKey, GetAddress(0x8DFD60, 0x8DFC70, 0x8DFC80));
		DefineAddress(func34h, GetAddress(0x8E0F00, 0x8E0C10, 0x8E0C20));
		DefineAddress(GetFileKeys, GetAddress(0x8E0FF0, 0x8E0CF0, 0x8E0D00));
		DefineAddress(func3Ch, GetAddress(0x8E11D0, 0x8E0ED0, 0x8E0EE0));
		DefineAddress(func40h, GetAddress(0x8E0A50, 0x8E0760, 0x8E0770));
		DefineAddress(SetResourceFactory, GetAddress(0x8E2010, 0x8E1D10, 0x8E1D20));
		DefineAddress(GetResourceFactory, GetAddress(0x8DFED0, 0x8DFDE0, 0x8DFDF0));
		DefineAddress(GetResourceFactories, GetAddress(0x8E03D0, 0x8E01F0, 0x8E0200));
		DefineAddress(AddDBPF, GetAddress(0x8E12F0, 0x8E0FF0, 0x8E1000));
		DefineAddress(GetPriority, GetAddress(0x8DE780, 0x8DE5D0, 0x8DE5E0));
		DefineAddress(GetDBPF, GetAddress(0x8DE7C0, 0x8DE610, 0x8DE620));
		DefineAddress(GetAllDBPFs, GetAddress(0x8E0550, 0x8E0370, 0x8E0380));
		DefineAddress(func60h, GetAddress(0x8DEFB0, 0x8DEEB0, 0x8DEEC0));
		DefineAddress(func64h, GetAddress(0x8E2310, 0x8E2010, 0x8E2020));
		DefineAddress(GetResourceCache, GetAddress(0x8DE810, 0x8DE660, 0x8DE670));
		DefineAddress(func6Ch, GetAddress(0x8DE860, 0x8DE6B0, 0x8DE6C0));
		DefineAddress(func70h, GetAddress(0x8DE8B0, 0x8DE700, 0x8DE710));
		DefineAddress(GetResourceCaches, GetAddress(0x8E05E0, 0x8E0400, 0x8E0410));
		DefineAddress(AddFileName, GetAddress(0x8DE6E0, 0x8DE530, 0x8DE540));
		DefineAddress(GetFileName, GetAddress(0x8E0660, 0x8E0480, 0x8E0490));
		DefineAddress(SetFileName, GetAddress(0x8E1A40, 0x8E1740, 0x8E1750));
		DefineAddress(RemoveFileName, GetAddress(0x8E1AA0, 0x8E17A0, 0x8E17B0));
		DefineAddress(GetTypeID, GetAddress(0x8DFF50, 0x8DFE60, 0x8DFE70));
		DefineAddress(GetExtension, GetAddress(0x8E0010, 0x8DFF20, 0x8DFF30));
		DefineAddress(AddExtensionMapping, GetAddress(0x8E1B20, 0x8E1820, 0x8E1830));
		DefineAddress(RemoveExtensionMapping, GetAddress(0x8E1BD0, 0x8E18D0, 0x8E18E0));
